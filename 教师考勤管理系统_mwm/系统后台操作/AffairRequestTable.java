...
public class AffairRequestTable{
...
//		sql = "select * from request where teacher_no = " + Main.teacher.getNo();
//		try {
//			Main.sqlconnect.stmt = Main.sqlconnect.ct.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
//		} catch (SQLException e) {
//			// TODO Auto-generated catch block
...
//		}
		...
		while(no.hasNext()) {
			...
			if(adminno == null || adminno.length() == 0) {
				...
				String sql1 = "select admin_name as 管理员姓名, admin_telephone as 管理员联系电话, admin_mailbox as 管理员联系邮箱 from administrator where admin_no = \'";
				sql1 += adminno;
				sql1 += "\'";
				try {
					Main.sqlconnect.stmt = Main.sqlconnect.ct.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
